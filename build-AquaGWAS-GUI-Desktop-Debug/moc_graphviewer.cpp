...
#include "../AquaGWAS-GUI/graphviewer.h"
...
QT_MOC_LITERAL(1, 12, 13), // "doubleClicked"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 21), // "mouseDoubleClickEvent"
QT_MOC_LITERAL(4, 49, 12), // "QMouseEvent*"
QT_MOC_LITERAL(5, 62, 1) // "e"

    },
    "GraphViewer\0doubleClicked\0\0"
    "mouseDoubleClickEvent\0QMouseEvent*\0e"
};
...
void GraphViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphViewer::doubleClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GraphViewer::doubleClicked()
{
