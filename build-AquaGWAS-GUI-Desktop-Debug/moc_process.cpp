...
#include "../AquaGWAS-GUI/process.h"
...
QT_MOC_LITERAL(1, 8, 15), // "outMessageReady"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 15), // "errMessageReady"
QT_MOC_LITERAL(4, 41, 20), // "on_readProcessOutput"
QT_MOC_LITERAL(5, 62, 19), // "on_readProcessError"
QT_MOC_LITERAL(6, 82, 19) // "on_terminateProcess"

    },
    "Process\0outMessageReady\0\0errMessageReady\0"
    "on_readProcessOutput\0on_readProcessError\0"
    "on_terminateProcess"
};
...
void Process::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->outMessageReady((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->errMessageReady((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->on_readProcessOutput(); break;
        case 3: _t->on_readProcessError(); break;
        case 4: _t->on_terminateProcess(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Process::outMessageReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Process::*)(const QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Process::errMessageReady)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Process::outMessageReady(const QString _t1)
{
...
// SIGNAL 1
void Process::errMessageReady(const QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
